  /* Scrollto for People */
    ...
    $('#amol').click(function(){ $('html,body').animate({ scrollTop:   $('#Amol_Kapoor').offset().top},300);});
    $('#maulin').click(function(){ $('html,body').animate({ scrollTop:   $('#Maulin_Hemani').offset().top},300);});
